                    ...
                    <div class="table-box" style="min-height: 501px;">
                        ...
                        <div class="box-tools pull-right">
                            <div class="has-feedback" >
                                <form class="search_form" action="${pageContext.request.contextPath}/sysLog/findAll.do" method="post">
                        ...
                        <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                            ...
                            <tr style="background: lightsteelblue;">
                                ...
                                <th style="text-align: center;">访问用户</th>
                                <th style="text-align: center;">访问IP</th>
                                <th style="text-align: center;">资源URL</th>
                            ...
                            <c:forEach items="${pageInfo.list}" var="syslog">
                                <tr>
                                    <td style="word-wrap:break-word;text-align: center;">${syslog.id}</td>
                                    <td style="word-wrap:break-word;text-align: center;">${syslog.visitTimeStr }</td>
                                    <td style="word-wrap:break-word;text-align: center;">${syslog.username }</td>
                                    <td style="word-wrap:break-word;text-align: center;">${syslog.ip }</td>
                                    <td style="word-wrap:break-word;text-align: center;">${syslog.url}</td>
                                    <td style="word-wrap:break-word;text-align: center;">${syslog.executionTime}毫秒</td>
                                    <td style="word-wrap:break-word;text-align: center;">${syslog.method}</td>
                                </tr>
                            </c:forEach>
                            </tbody>
                        </table>
                ...
                <div class="box-footer" style="padding: 0 30px 0 20px">
                    ...
                    <div class="box-tools pull-right">
                        <ul class="pagination" style="margin: 0px">
                            <li>
                                <a href="${pageContext.request.contextPath}/sysLog/findAll.do?page=1" aria-label="Previous">首页</a>
                            </li>
                            <li><a href="${pageContext.request.contextPath}/sysLog/findAll.do?page=${pageInfo.pageNum-1}">上一页</a></li>
                            <!--中间页码开始-->
                            <c:if test="${pageInfo.pages < 10}">
                                <c:forEach begin="1" end="${pageInfo.pages}" var="pageNum">
                                    <li><a href="${pageContext.request.contextPath}/sysLog/findAll.do?page=${pageNum}">${pageNum}</a></li>
                                </c:forEach>
                            </c:if>
                            <c:if test="${pageInfo.pages >= 10}">
                            ...
                            <!--中间页码结束-->
                            <li><a href="${pageContext.request.contextPath}/sysLog/findAll.do?page=${pageInfo.pageNum+1}">下一页</a></li>
                            <li>
                                <a href="${pageContext.request.contextPath}/sysLog/findAll.do?page=${pageInfo.pages}" aria-label="Next">尾页</a>
                            </li>
                        </ul>
                    </div>
